...
export async function GET(
  ...
  const finalApiUrl = `${API_BASE_URL}/api/projects/search_top_projects?q=${encodeURIComponent(q)}&limit=${encodeURIComponent(limit)}`;
  ...
  try {
    ...
    console.error(`Error in project search API route for search term ('${q}'):`, error);
